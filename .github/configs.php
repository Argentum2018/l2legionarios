...
##                  Configuraciones                      ##
###########################################################
$panel_url = 'www.l2New_Orden.com/ucp'; // Escriba exactamente la URL donde se encuentra este panel (ejemplo: www.olimpoc4.com/ucp)
...
###########################################################
$coinName = 'Donation Coin'; // Nombre de la moneda online que representa el saldo (utilizado sólo en el panel de usuario)
$coinName_mini = 'DC'; // Nombre resumido de la moneda
...
$MercadoPago['client_id'] = '2674528765329488'; // "CLIENT_ID" presente en la página https://www.mercadopago.com.ar/integrations/v1/web-payment-checkout.js
$MercadoPago['client_secret'] = 'RqLEDVvOCLQTe3CwnTqFuxe6OaN95mIg'; // "CLIENT_SECRET" presente en la página https://www.mercadopago.com.ar/integrations/v1/web-payment-checkout.js
$MercadoPago['currency'] = 'ARS'; // Código de la moneda
$MercadoPago['symbol'] = '$'; // Symbol moneda
$MercadoPago['coin_price'] = '10.00'; // Valor de la cantidad comercializada (en Reais)
...
$Banking['coin_price'] = '10.00'; // Valor de la cantidad comercializada
$Banking['bank_dados'] = '
